...
This file mirrors `agents.md` at repo root (kept for tooling that expects it there).
...
Keep the repo root minimal (code/config + `README.md` + `agents.md`). Put new notes/specs under `docs/`.
